...
Att ange `classified_as` är i normalfallet inte ett krav hos K-samsök. Men det är starkt, *starkt* rekommenderat! Datamängder som saknar typer begränsar datats värde, och kommer att få väldigt låga kvalitetsbetyg av just denna anledning. Att ange `language` för textfält är dock ett krav.
